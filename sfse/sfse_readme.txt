Starfield Script Extender v0.2.17 pre-alpha
...
SFSE will support the latest version of Starfield available on Steam, currently 1.15.216. The Gamepass/MS Store/EGS version is unsupported. Do not email asking for support.
